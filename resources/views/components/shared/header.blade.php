<header
			...
			<img src="{{asset('assets/img/hero2.webp')}}" alt="Piękny widok który mozna spotkac nieopodal Willa Wiesia w Kościelisku" class="w=full h-full object-cover object-top" width='' height="" >
